...
import { Search, Loader2, ChevronDown, ChevronUp, ExternalLink, Terminal } from 'lucide-react';
                ...
                <tbody>
                  {result.results.map((lead, i) => (
                    ...
                    >
                      ...
                      <td className="px-3 py-2.5 font-bold max-w-[180px] truncate">{lead.name}</td>
