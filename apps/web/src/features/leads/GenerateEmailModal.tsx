...
export function GenerateEmailButton({
  ...
  return (
    <>
      ...
      {open && <GenerateEmailModal leadId={leadId} onClose={() => setOpen(false)} onGenerated={onGenerated} />}
    </>
  );
}
            ...
            <>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-2 bg-foreground text-background text-[10px] font-bold uppercase tracking-widest hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
                >
